...
void loco3::init(){
    ...
    if (!m_backgroundTexture.loadFromFile("assets/textures/Scenes/loco3.png")) {
...
void loco3::update(sf::Time dt){}

void loco3::render(sf::RenderWindow& window) {
...
void loco3::loadNeighborDialogs() {};